...
function setup(){
    ...
    charts.push(new BarChart(500,800,100,600, data, 5,'Year','Total','Total Suicides'))
    charts.push(new StackedChart(500,800,1200,600, data, 5,'Year','Male','Female'))
    charts.push(new HorizontalChart(500,800,100,1500, data, 5,'Year','Total'));
